...
const selectClassNames: ClassNamesConfig = {
  control: (state) => `
    ...
    rounded-md shadow-sm min-h-[38px] // Ensure consistent height
  `,
  valueContainer: () => 'p-1 gap-1',
  input: () => 'm-0 p-0 text-gray-900 dark:text-white', // Ensure input text color is correct
  placeholder: () => 'text-gray-400 dark:text-gray-500 ml-0.5', // Adjusted placeholder style
  singleValue: () => 'text-gray-900 dark:text-white ml-0.5', // Ensure single value text color is correct
  ...
  menu: () => 'p-1 mt-1 text-sm bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg z-10', // Ensure menu is above other elements
  option: (state) => `
...
export default function NewTrack() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to create track. Please try again.');
      setLoading(false);
    }
  };
        ...
        <div className="space-y-12 sm:space-y-16">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-600 dark:text-gray-400">
              Create a new tour track with activities, locations, and a guide
            </p>
